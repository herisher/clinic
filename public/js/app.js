...
/* Btn Collapse Advance search */

$(function() {
    $('#btn-advsearch').click(function () {
        if ($('a i').hasClass('fa fa-search-plus')) {
            $('#btn-advsearch').html('<i class="fa fa-search-minus">&nbsp</i> Close');
        }
        else {
            $('#btn-advsearch').html('<i class="fa fa-search-plus">&nbsp</i> Advance Search');
        }
    });

});

/* Btn Collapse Add Action */

$(function() {
    $('#btn-addaction').click(function () {
        if ($('a i').hasClass('fa fa-plus')) {
            $('#btn-addaction').html('<i class="fa fa-search-minus">&nbsp</i> Close');
        }
        else {
            $('#btn-addaction').html('<i class="fa fa-plus">&nbsp</i> Add Action');
        }
    });
