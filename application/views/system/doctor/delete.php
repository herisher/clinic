        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-solid box-gold">
                    ...
                    <form name="form2" id="edit" action="<?php echo base_url();?>system/doctor/delete/<?php echo $doctor_id; ?>" method="post" enctype="multipart/form-data">
                        <section class="content">
                            <div class="container-form">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="alert alert-danger">
                                            <h4><span class="glyphicon glyphicon-warning-sign"></span> &nbsp; Are you sure you would like to remove Dokter <?= $datas['doctor_name']?> ?</h4>
                                        </div>
                                    </div>
                                </div>
