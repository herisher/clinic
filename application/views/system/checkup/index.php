...
<aside class="right-side">
    <section class="content-header">
        <h1>
            <i class="fa fa-user">&nbsp;</i>  Pemeriksaan
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-gold">
                    <div class="box-body">
                        <ol class="breadcrumb ">
                            <li> <i class="fa fa-user">&nbsp;</i> Pemeriksaan</a></li>
                        </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group" id="filter_col1" data-column="1">
                                            ...
                                            <input id="address" class="form-control" type="text" placeholder="Alamat" value="" name="address" data-column="4"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
...
<script>
    ...
    dTable = $('#index_table').DataTable( {
        ...
        "columnDefs": [
            ...
            { "orderable": true, "targets": 4, "searchable": true }, //Address
	...
	$('#checkup_name').on( 'keyup', function () {
    dTable
        .columns( 3 )
        .search( this.value )
        .draw();
